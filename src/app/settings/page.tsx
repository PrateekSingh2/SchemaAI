            ...
            <div className="space-y-5 animate-in fade-in duration-150">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="sm:col-span-2 space-y-1.5">
                          ...
                          <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-[#141210] border border-[#292524] text-xs text-stone-200 focus:outline-none focus:border-[#38bdf8] font-mono"
                          />
                        </div>
                        <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            <input
                              ...
                              placeholder="••••••••••••"
                              className="w-full pl-3.5 pr-10 py-2.5 rounded-xl bg-[#141210] border border-[#292524] text-xs text-stone-200 focus:outline-none focus:border-[#38bdf8] font-mono"
                            />
                            <button
                              type="button"
                ...
                <>
                  {currentMode === "apikey" ? (
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-stone-300 flex items-center gap-1.5">
                          <Globe className="w-3.5 h-3.5 text-[#38bdf8]" /> Supabase Project URL
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-stone-300 flex items-center justify-between">
                          <span className="flex items-center gap-1.5">
                            <Key className="w-3.5 h-3.5 text-emerald-400" /> API Key (service_role or anon key)
                          </span>
                          <span className="text-[11px] text-zinc-400">Project Settings &gt; API</span>
                        </label>
                        <div className="relative">
                          <input
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="sm:col-span-2 space-y-1.5">
                          <label className="text-xs font-semibold text-stone-300">Pooler Host (IPv4)</label>
                          <input
                            type="text"
                            value={config.host || ""}
                            onChange={(e) => setConfig({ ...config, host: e.target.value })}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-stone-300 flex items-center gap-1">
                            <Lock className="w-3.5 h-3.5 text-stone-400" /> Database Password
                          </label>
                          <div className="relative">
                            <input
                              type={showPassword ? "text" : "password"}
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <label className="text-xs font-semibold text-stone-300 flex items-center gap-1.5">
                          <Globe className="w-3.5 h-3.5 text-[#38bdf8]" /> Supabase Connection Pooler URI (IPv4)
                        </label>
                        <span className="text-[10px] text-[#38bdf8] font-mono">Port 6543 / 5432</span>
                      </div>
                      <input
                        type="text"
                        value={config.connectionUri}
              ...
              {config.dbType === "MySQL" && (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-2 space-y-1.5">
                      <label className="text-xs font-semibold text-stone-300">Host Endpoint</label>
                      <input
                        type="text"
                        value={config.host || ""}
                        onChange={(e) => setConfig({ ...config, host: e.target.value })}
