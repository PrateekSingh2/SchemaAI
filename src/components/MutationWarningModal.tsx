  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-xl animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="h-1.5 w-full bg-gradient-to-r from-amber-500 via-rose-500 to-red-600 sticky top-0 z-10" />

        {/* Modal Header */}
        <div className="p-4 sm:p-6 pb-3 sm:pb-4">
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-3 sm:space-x-3.5">
              <div className="p-2.5 sm:p-3 rounded-2xl bg-rose-500/15 border border-rose-500/30 text-rose-400 shadow-inner shrink-0">
                <ShieldAlert className="w-5 h-5 sm:w-6 sm:h-6 animate-pulse" />
              </div>
              <div className="space-y-1">
                <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-rose-500/20 text-rose-300 border border-rose-500/40 text-[9px] sm:text-[10px] font-mono font-bold tracking-wider uppercase">
        ...
        <div className="px-4 sm:px-6 py-2 space-y-3 sm:space-y-4">
          ...
          {/* Warning Message */}
          <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-[11px] sm:text-xs flex items-start space-x-2.5">
